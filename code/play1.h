...
void play1(unsigned char **mat2, unsigned char **mat2_bis,  char *pseudo)
{
    ...
    while (1) {
        ...
        if (keypressed == 'q'){
            system("cls");
            exitgame(mat2, mat2_bis, pseudo);
        }
        
        if (keypressed == 's'){
            system("cls");
            choice_saving_game1(mat2, mat2_bis, pseudo);
        }
        
        if (keypressed == 'm'){
            system("cls");
            menu1(mat2, mat2_bis, pseudo);
        }
